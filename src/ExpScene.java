...
public class ExpScene extends JPanel implements MouseMotionListener {
	...
	public ExpScene() {
		...
		forwardButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) { //on click
				...
				if(numImage > 2){
					Driver.removeExpSceneFromPanel();
					Driver.addAdasRoom(); //change to Main.addFirstForest if you want it to go back to mvp
